...
namespace Chitic__Valentina_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        ...
        public void PopulateAssignedCategoryData(Chitic__Valentina_Lab8Context context, Book book)
        {
        ...
        public void UpdateBookCategories(Chitic__Valentina_Lab8Context context, string[] selectedCategories, Book bookToUpdate)
        {
